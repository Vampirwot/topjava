...
@NamedQueries(
        {
                ...
                @NamedQuery(name = Meal.BETWEEN, query = "select m from Meal m where m.user.id = :user_id and m.dateTime >= :start AND m.dateTime< :end ORDER BY m.dateTime DESC")
        }
)
...
public class Meal extends AbstractBaseEntity {
    ...
    public static final String BETWEEN = "MEAL.getAllBetween";
